...
#' nom.cop <- new("CopulaObj",
#'   param = c(0.5, 0.5, 0.5), marginal = list(dist1 = dist1, dist2 = dist2, dist3 = dist3),
...
#' x[, 1] <- Quantile(dist1, x[, 1])
#' x[, 2] <- Quantile(dist2, x[, 2])
#' cla.cop <- new("CopulaObj",
#'   type = "clayton", param = c(3),
...
#' x[, 2] <- Quantile(dist2, x[, 2])
#' cla.cop <- new("CopulaObj",
#'   type = "clayton", param = c(3), marginal = list(dist1 = dist1, dist2 = dist2),
