...
#' data(claimdata)
#' # IBNR simulation
#' claimobj <- new("ClaimType",
#'   line = "Auto", claimType = "N", iRBNER = FALSE, iROPEN = FALSE,
#'   iIBNR = TRUE, iUPR = FALSE,
#'   IBNRfreqIndex = new("Index",
#'     startDate = as.Date("2016-01-01"),
#'     monthlyIndex = rep(30, 12)
#'   ), iCopula = TRUE
#' )
  ...
  tryCatch(
    {
      ...
      if (object@iRBNER == TRUE) {
        ...
        if (nobs > 0) {
          ...
          tmpdata <- tmpdata[, c(
            "ClaimID", "LoB", "Type", "status", "occurrenceDate", "reportDate", "incurredLoss", "osRatio", "settlementDate", "totalLoss", "ultimateLoss", "Deductible",
